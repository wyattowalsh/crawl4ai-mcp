...
description: Development timeline and future plans for MCP-Crawl4AI
---
...
We maintain a backlog of feature requests and ideas for future development. If you have a feature request, please open an issue on our [GitHub repository](https://github.com/wyattowalsh/mcp-crawl4ai/issues) with the "feature request" label.

<Callout type="info">
  Want to prioritize specific features or collaborate on development? Reach out to us on [GitHub](https://github.com/wyattowalsh/mcp-crawl4ai).
</Callout>
